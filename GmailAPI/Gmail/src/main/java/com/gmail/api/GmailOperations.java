...
public class GmailOperations {
	...
	public static void sendEmailWithAttachment() throws IOException, GeneralSecurityException, MessagingException {
		...
		Gmail service = GmailAPI.getGmailService();
		MimeMessage Mimemessage = createEmailWithAttachment("afsarali273@gmail.com","me","This my demo test subject","This is my body text",new File("./result.html"));
	...
	public static void sendEmailWithHTMLBodyAndAttachment() throws IOException, AddressException, MessagingException, GeneralSecurityException {
		...
		Gmail service = GmailAPI.getGmailService();
		MimeMessage Mimemessage = createHTMLEmailBodyWithAttachment("afsarali273@gmail.com,abc@gmail.com", "This is a subject test", htmlText, "./result.html");
